      ...
      <div className={stage === 'profiles' ? 'w-full' : 'mx-auto w-full max-w-7xl'}>
        ...
        {stage === 'profiles' && (
          <div className="mx-auto w-full max-w-5xl px-6 flex flex-col items-center">
            {/* ── Hero Header ── */}
            <header className="pt-24 pb-28 md:pb-24 lg:pb-20 text-center flex flex-col items-center">
            ...
            {/* ── Profile Cards Grid ── */}
            <div className="mt-16 md:mt-20 lg:mt-24 flex flex-wrap justify-center gap-6 pb-24">
